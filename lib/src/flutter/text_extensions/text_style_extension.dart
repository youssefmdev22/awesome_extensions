...
extension TxtStyle on TextStyle {
  ...
  TextStyle get medium => copyWith(fontWeight: .w500);
  ...
  TextStyle get light => copyWith(fontWeight: .w300);
  TextStyle get w300 => copyWith(fontWeight: .w300);

  /// Extra-light - FontWeight.w200
  TextStyle get extraLight => copyWith(fontWeight: .w200);
  TextStyle get w200 => copyWith(fontWeight: .w200);

  /// Thin, the least thick - FontWeight.w100
  TextStyle get thin => copyWith(fontWeight: .w100);
  TextStyle get w100 => copyWith(fontWeight: .w100);
}
